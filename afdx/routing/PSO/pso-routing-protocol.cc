#include "pso-routing-protocol.h"
...
PSORoutingProtocol::PSORoutingProtocol(){
...
// hop (if needed)
Ptr<Ipv4Route> PSORoutingProtocol::RouteOutput(Ptr<Packet> p,
...
int PSORoutingProtocol::minDistance(int distance[], bool shortestPath[])
{
...
void PSORoutingProtocol::returnPath(int currentVertex, vector<int> parents, vector<int> &path)
{
    if (currentVertex == -1) {
        return;
    }
...
bool PSORoutingProtocol::checkIfRouteExists(Ptr<Ipv4GlobalRouting> gr, Ipv4Route route)
{
...
void PSORoutingProtocol::returnShortestPath(int startVertex, vector<int> distances, vector<int> parents)
{
...
void PSORoutingProtocol::BuildGlobalRoutingDatabase()
{
...
void PSORoutingProtocol::PopulateRoutingTables() 
{
    BuildGlobalRoutingDatabase();
}

void PSORoutingProtocol::RecomputeRoutingTables() 
{
    BuildGlobalRoutingDatabase();
}
